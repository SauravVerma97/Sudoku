...
{   
    ...
    void sudokuGenerator(int grid[][], int difficulty)
    {
        ...
        for(int i=0; i<9; i++)
        {
            for(int j=0; j<num1; j++)      // This loop help's us in removing random elements from each row
            {
                while( true )
                {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                for(int i=0; i<81; i++)
                {
                    if( boxCheck[i/9][i%9]==0 )
                    {
                        if( box[i].getText().equals("") )
                        {
                            JOptionPane.showMessageDialog(null, "Complete the Sudoku before submittin!!");
                            flag1 = 0;
                            break;
                        }
                ...
                if( flag1==1 )
                {
                    if( flag==1 )
                        ...
                        JOptionPane.showMessageDialog(null, "WOW, correct Answer!!");
                }
            }
        });
        b3.setBounds(560, 450, 120, 50);
